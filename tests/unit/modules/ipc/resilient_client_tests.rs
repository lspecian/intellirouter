...
use intellirouter::modules::ipc::chain_engine::{
    CancelChainResponse, Chain, ChainEngineClient, ChainExecutionEvent, ChainExecutionResponse,
    ChainStatusResponse, Status,
};
use intellirouter::modules::ipc::resilient::{
    chain_engine_client::ResilientChainEngineClient,
    circuit_breaker::default_circuit_breaker_config, config::default_retryable_error_categories,
};
use intellirouter::modules::ipc::{IpcError, IpcResult};
use intellirouter::modules::router_core::retry::RetryPolicy;
...
async fn test_circuit_breaker_opens_after_failures() {
    ...
    let circuit_breaker_config = intellirouter::modules::router_core::retry::CircuitBreakerConfig {
