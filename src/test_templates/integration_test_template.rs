...
// This ensures the template is only compiled during tests
#[cfg(test)]
mod tests {
    ...
    fn test_database_integration() {
        ...
        let component = module_a::initialize_with_db(db.clone())
            .expect("Failed to initialize component with DB");
